...
$mail = new PHPMailer();
$emailTO = $emailBCC =  $emailCC = array(); $formEmail = 'goplugin.co@gmail.com';

### Enter Your Sitename 
$sitename = 'Goplugin';

### Enter your email addresses: @required
$emailTO[] = array( 'email' => 'goplugin.co@gmail.com', 'name' => 'Goplugin' ); 
...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
	if (isset($_POST["contact-email"]) && $_POST["contact-email"] != '' && isset($_POST["contact-name"]) && $_POST["contact-name"] != '') {
		...
		$cf_mobile = $_POST["contact-mobile"];
		//$cf_company = $_POST["contact-company"];
		...
		if ($honeypot == '' && !(empty($emailTO))) {
			...
			$mail->Port = 587;
			$mail->SMTPAuth = true;
			$mail->Username = 'AKIAZRH4KSFLHRBCVO5L';
			$mail->Password = 'BGfdlaMVfBx6zKVBo2EcVNluw+K+F2DXtjF7sizteTV6';
			...
			$bodymsg .= isset($cf_mobile) ? "Contact Mobile: $cf_mobile<br><br>" : '';
